...
// 	ДокументСсылка 
// 	Неопределено
Функция НайтиТекущуюРеализацию(ТекущийОбъект) Экспорт
	...
	|		ИЗ
	|			Константа.ВКМ_НоменклатураРаботыСпециалиста КАК BKM_НоменклатураРаботыСпециалиста)
...
// Возвращаемое значение:
// 	Булево
Функция ДокРеализацияПроверить(Знач Объект) Экспорт
	...
	ДатаНачалИДатаОкончанияДоговора = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Объект.Договор,"ВКМ_ДатаНачалаДействия,ВКМ_ДатаОкончанияДействия");
	Если ДатаНачалИДатаОкончанияДоговора.ВКМ_ДатаНачалаДействия > Объект.Дата 
		Или   ДатаНачалИДатаОкончанияДоговора.ВКМ_ДатаОкончанияДействия < Объект.Дата Тогда
