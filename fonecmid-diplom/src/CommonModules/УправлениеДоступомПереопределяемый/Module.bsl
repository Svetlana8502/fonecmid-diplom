...
// ВКМ_Доработка: Добавление Профилей групп доступа

	//Менеджер
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
    ОписаниеПрофиля.Имя = "Менеджер";
    ОписаниеПрофиля.Наименование  = НСтр("ru = 'Менеджер по обслуживанию клиентов'", ОбщегоНазначения.КодОсновногоЯзыка());
    ОписаниеПрофиля.Идентификатор = "15e98212-0708-4122-8326-724810619567";
    ...
    ОписаниеПрофиля.Идентификатор = "7b231668-450b-449d-8d63-93666b677a2d";
    ...
    ОписаниеПрофиля.Наименование  = НСтр("ru = 'Бухгалтер по реализации'", ОбщегоНазначения.КодОсновногоЯзыка());
    ОписаниеПрофиля.Идентификатор = "d999088b-1e24-4690-951c-662580665f80";
    ...
    ОписаниеПрофиля.Идентификатор = "5e8c1b2f-4a3d-4b9e-8f1c-d7a2b3c4e5f6";
